 ...
 *   Kirill bosh harflari avval `translate()` bilan kichraytiriladi: `lower()` DB locale'iga
 *   bog'liq (`C`/`POSIX` collation'da faqat ASCII) — natija har qanday bazada bir xil bo'lsin.
    ...
    RETURN btrim(regexp_replace(
      replace(
        translate(
          ...
          'абвгдезийклмнопрстуфхэыжқғўҳʻʼ''‘’\`´ʹ′ьъ',
