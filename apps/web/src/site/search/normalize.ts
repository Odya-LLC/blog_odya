 ...
 * (`migrations/*_m1_07_search.ts`). Biri o'zgarsa, ikkinchisi ham o'zgartiriladi va yangi
 * migratsiya yoziladi; integratsion test ikkisini solishtiradi (`C` collation'da ham).
 *
 * Yon ta'sirsiz — unit testlanadi.
 */

/**
 * Apostrof variantlari: U+02BB ʻ, U+02BC ʼ, ASCII ', U+2018 ‘, U+2019 ’, backtick, U+00B4 ´,
 * U+02B9 ʹ, U+2032 ′.
 */
