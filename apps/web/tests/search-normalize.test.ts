 ...
 * (`odya_search_normalize`) bilan bir xilligi — `site-pages.int.test.ts`.
 */
describe('qidiruv normalizatsiyasi', () => {
  it.each([
    ...
    ['Sunʼiy', 'suniy'],
    ["sun'iy", 'suniy'],
    ['oʹzbek o´zbek o′zbek', 'ozbek ozbek ozbek'],
  ...
  it.each([
    ...
    ['Эълон', 'elon'],
    ['компьютер', 'kompyuter'],
    ['ЎЗБЕКИСТОН ҚИДИРУВ ҒАЛАБА ҲАФТА ЁШЛАР', 'ozbekiston qidiruv galaba hafta yoshlar'],
